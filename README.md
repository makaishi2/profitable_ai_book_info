...
1章 \UTF{2003} 業務と機械学習プロジェクト  
2章 \UTF{2003} 機械学習モデルの処理パターン   
3章 \UTF{2003} 機械学習モデルの開発手順  
4章 \UTF{2003} 機械学習モデル開発の重要ポイント   
5章 \UTF{2003} 業務要件と処理パターン  
・営業成約予測（分類）  
・天候による売り上げ予測（回帰）   
・季節などの周期性で売り上げ予測（時系列分析）   
・お薦め商品の提案（アソシエーション分析）  
・顧客層に応じた販売戦略（クラスタリング、次元圧縮）   
6章 \UTF{2003} AIプロジェクトを成功させる上流工程のツボ  
